//! Native connector ABI for ClickHouse.
//!
...
const HEALTH_RESPONSE_JSON: &str =
    r#"{"ok":true,"engine":"clickhouse","abiVersion":1,"driverLinked":false}"#;
const DESCRIBE_RESPONSE_JSON: &str = concat!(
    r#"{"ok":true,"engine":"clickhouse","abiVersion":1,"driverLinked":false,"manifest":"#,
